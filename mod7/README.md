...
1. [ルール] タブをクリックします。
1. リスナールールの一覧で、[ルール 1]の行の中央にある [アクション 1.**転送先**] の 下に表示されているリンク (例: k8s-student0-myservic-75a7) をクリックします。これにより、ターゲットグループの情報が表示されます。
1. ページ下部にある [ターゲット] タブをクリックします。[IP アドレス] に表示されている IPアドレスが、メモしておいた Pod の IPアドレスと同じであることを確認します。
